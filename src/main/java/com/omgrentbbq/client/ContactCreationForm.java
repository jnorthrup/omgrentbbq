...
*/
        contact.address1 = address1.getText();
        if (contact.address1.length() < 5) s += "address1 too short<br/>";
        contact.phone = phone.getText();

        if (contact.phone.length() < 10) s += "phone too short<br/>";
        ...
        */
        contact.city = city.getText();
        if (contact.city.length() < 3) s += "city too short<br/>";
        contact.state = state.getText();
