                ...
                addClickHandler(new ClickHandler() {
                    ...
                    public void onClick(ClickEvent clickEvent) {
                        ...
                        if (nicknameVal.isEmpty()) {
                            payee.nickname = contact.name + ((acctVal.isEmpty()) ? "" : "-" + acctVal);
                            nickname.setText(payee.nickname);
                        } else payee.nickname = nicknameVal;
                        payee.account = acctVal;
                        payee.periodicity = Periodicity.values()[payCycleListbox.getSelectedIndex()];
                        payee.fax = fax.getText();
                        payee.schedule = payee.periodicity.getSchedule(scheduleWidget, captionPanel);
