...
public class GoogleBaseQuerySnippetsForJobsDemo extends GDataDemo {
  ...
  public static GDataDemoInfo init() {
    return new GDataDemoInfo() {
      ...
      public GDataDemo createInstance() {
        return new GoogleBaseQuerySnippetsForJobsDemo();
      }

      @Override
      public String getDescription() {
        return "<p>This sample uses a snippets query to find items " +
            "corresponding to jobs that match a set of criteria.</p>";
      }

      @Override
      public String getName() {
        return "Base - Querying snippets for jobs";
      }
    };
  }
  ...
  private void querySnippets(String itemsFeedUri) {
    ...
    query.setBq(
        "[employer: Google][job type:full-time][job function:Marketing]");
