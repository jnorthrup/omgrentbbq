 ...
 * recipes matching a set of parameters.
 */
public class GoogleBaseQuerySnippetsForRecipesDemo extends GDataDemo {
  ...
  public static GDataDemoInfo init() {
    return new GDataDemoInfo() {
      ...
      public GDataDemo createInstance() {
        return new GoogleBaseQuerySnippetsForRecipesDemo();
      }
  ...
  private void querySnippets(String itemsFeedUri) {
    ...
    query.setBq("[item type:recipes][cuisine:chinese][course:main]" +
  ...
  */
  ...
  private void startDemo() {
    service = GoogleBaseService.newInstance(
        "HelloGData_GoogleBase_QuerySnippetsForRecipesDemo_v2.0");
